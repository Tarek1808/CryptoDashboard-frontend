          ...
          if (data.result) {
            ...
            fetch(`${BACKEND_ADDRESS}/wallet/${data.token}`)
              ...
              .then((dataWallets) => {
                ...
                fetch(
                  `${BACKEND_ADDRESS}/users/${data.token}/updateTotalValue`,
                  {
                    method: "PUT",
                    headers: { "Content-Type": "application/json" },
      ...
      <div className={styles.overlay}>
        <div className={styles.content}>
          <div className={styles.presentation}>
            <h2 className={styles.titlePresentation}>
              Welcome to Crypto Dashboard!
            </h2>
            <p className={styles.paragraphPresentation}>
              Crypto Dashboard revolutionizes cryptocurrency portfolio
              management. With intuitive charts, it provides real-time analysis
              of asset performance, empowering informed decision-making.
              Integrated news keeps you updated on market trends.
            </p>
            <p className={styles.paragraphPresentation}>
              Track changes since your last login for a precise view of
              investment evolution. Transform your cryptocurrency management
              approach with Crypto Dashboard today!
            </p>
          </div>
          <div className={styles.auth}>
            ...
            {errorId && (
              <p className={styles.error}>Invalid username and/or password</p>
            )}
